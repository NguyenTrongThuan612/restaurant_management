...
from app_core.errors.exceptions import UnVerifiedException
from app_core.helpers.otp import generate_otp, verify_otp
...
from app_core.serializers.user import VerifyUserSerializer
...
class AuthView(viewsets.ViewSet, TokenObtainPairView):
    ...
    def verify_account(self, request):
        try:
            ...
            try:
                account: User = User.objects.get(email=email)
